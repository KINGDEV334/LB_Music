...
API_ID = int(getenv("28938499", None))
API_HASH = getenv("5fbfbdb670be6ac9ce68ed8643033c16", None)

# Get your token from @BotFather on Telegram.
BOT_TOKEN = getenv("8155687416:AAFpQX7WytRbdLp2zXEGAMzbBZYah2dRAoY", None)
